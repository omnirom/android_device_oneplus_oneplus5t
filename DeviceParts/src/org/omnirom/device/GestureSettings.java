...
public class GestureSettings extends PreferenceFragment implements
    ...
    public static final String KEY_FP_SWIPE_DOWN_SWITCH = "fp_swipe_down_switch";
    ...
    private TwoStatePreference mFpSwipeDownNotificationSwitch;
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        ...
        mFpSwipeDownNotificationSwitch = (TwoStatePreference) findPreference(KEY_FP_SWIPE_DOWN_SWITCH);
        mFpDownSwipe = getResources().getBoolean(com.android.internal.R.bool.config_supportSystemNavigationKeys);
        mFpSwipeDownNotificationSwitch.setChecked(!mFpDownSwipe);


        mFPDownSwipeApp = (AppSelectListPreference) findPreference(FP_GESTURE_SWIPE_DOWN_APP);
        //mFPDownSwipeApp.setEnabled(!mFpDownSwipe);
        setFpSwipeDownGestureEnable(mFpDownSwipe);
    ...
    public boolean onPreferenceTreeClick(Preference preference) {
        ...
        if (preference == mFpSwipeDownNotificationSwitch) {
            setFpSwipeDownGestureEnable(!mFpDownSwipe);
            return true;
        }
    ...
    private boolean setFpSwipeDownGestureEnable(boolean mSval){
        ...
        Settings.System.putInt(getContext().getContentResolver(),
                    SYSTEM_NAVIGATION_KEYS_ENABLED, !mSval ? 1:0);
        mFPDownSwipeApp.setEnabled(mSval);
        return mSval;
    }
