...
public class GestureSettings extends PreferenceFragment implements
    ...
    public static final String KEY_FP_SWIPE_DOWN_SWITCH = "fp_swipe_down_switch_enabled";
    ...
    public void onCreatePreferences(Bundle savedInstanceState, String rootKey) {
        ...
        /*if (mFpDownSwipe){
            mFpSwipeDownSwitch.setChecked(false);
            mFpSwipeDownSwitch.setEnabled(false);
        } else {
            mFpSwipeDownSwitch.setChecked(Settings.System.getInt(getContext().getContentResolver(),
                Settings.System.KEY_FP_SWIPE_DOWN_SWITCH, !mFpDownSwipe));
            mFpSwipeDownSwitch.setEnabled(true);
        }*/
        //mFpDownSwipe = getResources().getBoolean(com.android.internal.R.bool.config_supportSystemNavigationKeys);
        
        /*if (mFpDownSwipe == true) {
            mFPDownSwipeApp.setEnabled(false);
        } else {
