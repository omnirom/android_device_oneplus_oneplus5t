...
public class KeyHandler implements DeviceKeyHandler {
    ...
    public boolean handleKeyEvent(KeyEvent event) {
        ...
        if (mFPcheck && mDispOn){
            ...
            //isActivityLaunchEvent(event);
            //launchSpecialActions(value);
            isCameraLaunchEvent(event);
        ...
        //getGestureValueForFPScanCode(fpcode);
    ...
    private String getGestureValueForFPScanCode(int scanCode) {
        switch(scanCode) {
            case FP_GESTURE_SWIPE_DOWN:
                boolean mFpDownSwipe = mContext.getResources().getBoolean(com.android.internal.R.bool.config_supportSystemNavigationKeys);
                if (mFpDownSwipe == false){
                    return Settings.System.getStringForUser(mContext.getContentResolver(),
